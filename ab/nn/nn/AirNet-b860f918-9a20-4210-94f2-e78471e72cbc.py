...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.image_size = 320  # Changed from 224
        self.num_classes = out_shape[0]
        self.learning_rate = 0.001  # Changed from prm['lr']
        self.momentum = 0.9  # Changed from prm['momentum']

        channels = [32, 64, 128, 256]  # Changed from [64, 128, 256, 512]
