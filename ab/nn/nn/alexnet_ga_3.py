...
chromosome = {'conv1_filters': 32, 'conv1_kernel': 3, 'conv1_stride': 1, 'conv2_filters': 256, 'conv2_kernel': 3, 'conv3_filters': 384, 'conv4_filters': 256, 'conv5_filters': 512, 'fc1_neurons': 1024, 'fc2_neurons': 2048}
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(
            ...
            # Layer 2
            nn.Conv2d(32, 256, kernel_size=3, padding=2),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2), # Adjusted for CIFAR-10's small image size
