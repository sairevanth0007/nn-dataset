...
chromosome = {'conv1_filters': 32, 'conv1_kernel': 3, 'conv1_stride': 2, 'conv2_filters': 192, 'conv2_kernel': 3, 'conv3_filters': 192, 'conv4_filters': 384, 'conv5_filters': 256, 'fc1_neurons': 1024, 'fc2_neurons': 1024}
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(
            # Layer 1
            nn.Conv2d(in_channels, 32, kernel_size=3, stride=2, padding=2),
