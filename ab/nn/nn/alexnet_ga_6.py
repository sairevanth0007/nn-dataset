...
chromosome = {'conv1_filters': 96, 'conv1_kernel': 5, 'conv1_stride': 2, 'conv2_filters': 128, 'conv2_kernel': 3, 'conv3_filters': 256, 'conv4_filters': 384, 'conv5_filters': 256, 'fc1_neurons': 1024, 'fc2_neurons': 4096}
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(
            # Layer 1
            nn.Conv2d(in_channels, 96, kernel_size=5, stride=2, padding=2),
