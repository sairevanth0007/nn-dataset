...
class DPN131(nn.Module):
    def __init__(self, growth_rate=32):
        ...
        self.conv1 = nn.Conv2d(3, growth_rate, kernel_size=3, padding=1)  # Modified
        ...
        self.fc = nn.Linear(growth_rate, 10)  # Modified
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.device = device
        model_class = DPN131
        self.channel_number = 3  # Modified
        self.image_size = in_shape[1]
        self.class_number = 10  # Modified
        self.model = model_class()  # Modified
