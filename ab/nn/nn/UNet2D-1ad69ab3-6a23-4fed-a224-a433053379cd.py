...
class UNet2DModel(nn.Module):
    def __init__(
            self,
            sample_size=64,  # Randomly selected integer
            in_channels=4,  # Randomly selected integer
            out_channels=256,  # Randomly selected integer
            layers_per_block=3,  # Randomly selected integer
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        image_size = prm['lr']  # Randomly selected integer
