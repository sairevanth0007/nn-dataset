...
def check_nn(nn_code : str, task : str, dataset : str, metric : str, prm: dict, save_to_db=True) -> tuple[str, float, int]:
    """
    ...
    """
    return Train.train_new(nn_code, task, dataset, metric, prm, save_to_db=save_to_db)
